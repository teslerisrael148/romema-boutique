...
export const products: Product[] = [
  // ───────────── מטפחות יומיומיות ─────────────
  {
    ...
    compareAtPrice: 149,
    category: "sale",
    tags: ["נושם", "קליל", "רב-תכליתי", "פולש מלא", "מבצע"],
    variants: [
  ...
  // ───────────── מטפחות לשבת ─────────────
  {
    ...
    compareAtPrice: 269,
    category: "sale",
    tags: ["סאטן", "מהודר", "ברק עדין", "שבת", "מבצע"],
    variants: [
  ...
  // ───────────── מטפחות לאירועים ─────────────
  {
    ...
    compareAtPrice: 449,
    category: "sale",
    tags: ["קריסטל", "ערב", "עבודת יד", "יוקרה", "מבצע"],
    variants: [
